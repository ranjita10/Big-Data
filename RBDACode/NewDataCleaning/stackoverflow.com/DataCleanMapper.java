...
String bodyContent = getValueFromXML(line, "Title=\"");
String CreationDate = getValueFromXML(line,"CreationDate=\"");
if (CreationDate.length() < 4 || bodyContent.length() == 0) {
...
if (startIndex == -1) {
	...
	int endIndex = lineFromXML.indexOf("\"", startIndex);

	return lineFromXML.substring(startIndex, endIndex);
